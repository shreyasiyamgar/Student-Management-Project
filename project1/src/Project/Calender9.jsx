...
const Calendar9 = () => {
  ...
  const startDay = new Date(2026, 2, 1).getDay(); // March 1, 2026

  const eventDays = [3, 19, 26, 31];
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans p-4 sm:p-6 md:p-8">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        <button className="text-4xl text-gray-700" onClick={() => navigate('/Calender8')}>{'<'}</button>
        <h3 className="text-2xl sm:text-4xl font-semibold">March, 2026</h3>
      ...
      <div className="flex flex-col gap-4 bg-indigo-100 mt-6 p-4 rounded-md w-full max-w-8xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
            ...
            <div className="text-lg lowercase">mar</div>
          </div>
          <div className="text-lg sm:text-2xl font-medium">Holi</div>
        </div>
        {/* Event 2 */}
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
          ...
          <div className="text-lg sm:text-2xl font-medium">Gudi Padwa / Ramzan Eid</div>
        </div>
        {/* Event 3 */}
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
          ...
          <div className="text-lg sm:text-2xl font-medium">Ram Navami</div>
        </div>
        {/* Event 4 */}
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
          ...
          <div className="text-lg sm:text-2xl font-medium">Mahavir Jayanti</div>
        </div>
      </div>
    </div>
  );
