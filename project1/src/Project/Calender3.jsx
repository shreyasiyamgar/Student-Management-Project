...
const Calendar3 = () => {
  ...
  const startDay = new Date(2025, 8, 1).getDay(); // September 1, 2025

  return (
    <div className="w-full min-h-screen bg-white font-sans p-4 sm:p-6 md:p-8">
      {/* Header */}
      <div className="flex items-center gap-2">
        <button className="text-yellow-500 text-6xl sm:text-6xl" onClick={() => navigate('/')}>←</button>
      ...
      {/* Tabs */}
      <div className="flex justify-around border-b border-gray-300 mt-8 text-xxl sm:text-4xl">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        ...
        <h3 className="text-2xl sm:text-4xl font-semibold">September, 2025</h3>
      ...
      <div className="flex flex-col gap-4 bg-indigo-100 mt-6 p-4 rounded-md w-full max-w-8xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
            ...
            <div className="text-lg sm:text-xl lowercase">sep</div>
          </div>
          <div className="text-lg sm:text-2xl font-medium">Eid-e-Milad</div>
        </div>
        {/* Event 2 */}
        <div className="flex items-center gap-4">
          <div className="bg-pink-200 text-black rounded-lg p-2 w-16 text-center">
          ...
          <div className="text-lg sm:text-2xl font-medium">Anant Chaturdashi</div>
        </div>
      </div>
    </div>
  );
