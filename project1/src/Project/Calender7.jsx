...
const Calendar7 = () => {
  ...
  const startDay = new Date(2026, 0, 1).getDay(); // January 1, 2026
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans p-4 sm:p-6 md:p-8">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        ...
        <h3 className="text-2xl sm:text-4xl font-semibold">January, 2026</h3>
      ...
      <div className="flex items-center gap-4 bg-indigo-100 mt-6 p-4 rounded-md w-full max-w-8xl mx-auto">
        ...
        <div className="text-lg sm:text-3xl font-medium">
          Christmas Vacations 
        </div>
      </div>
    </div>
