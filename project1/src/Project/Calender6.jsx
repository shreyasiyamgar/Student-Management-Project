...
const Calendar6 = () => {
  ...
  const startDay = new Date(2025, 11, 1).getDay(); // December 1, 2025
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans p-4 sm:p-6 md:p-8">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        ...
        <h3 className="text-2xl sm:text-4xl font-semibold">December, 2025</h3>
        <button className="text-4xl text-gray-700" onClick={() => navigate('/Calender7')}>{'>'}</button>
      </div>
      ...
      <div className="grid grid-cols-7 text-center bg-indigo-100 text-black py-2 sm:py-3 text-base sm:text-lg rounded-b-md">
        ...
        {Array.from({ length: 31 }, (_, i) => {
          const day = i + 1;
          const isVacation = day >= 23; // Vacation starts from Dec 23
          return (
      ...
      <div className="flex items-center gap-4 bg-indigo-100 mt-6 p-4 rounded-md w-full max-w-8xl mx-auto">
        <div className="bg-pink-200 text-black rounded-lg p-2 w-26 text-center">
          <div className="text-xl sm:text-2xl font-bold">23 Dec-2 Jan</div>
          <div className="text-lg sm:text-xl lowercase"></div>
        </div>
